...
describe('Common Utilities', () => {
    describe('mapByName', () => {
        it('Takes an array of Objects from the aws-sdk, and maps them by lowercase Name, Hostname, and Shortname', () => {
            const testArray = [
                { Name: 'long-test1' },
                { Hostname: 'test2' },
                { Shortname: 'test3' },
            ...
            expect(map).to.haveOwnProperty('test4');
            expect(map['test4'].Name).to.equal('TEST4');
        });
    });
});